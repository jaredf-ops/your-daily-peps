const siteConfig = {
  ...
  supplies: [
    { name: 'BAC Water (2ml)',                        price: 5  },
    { name: 'BAC Water (4ml)',                        price: 10 },
    { name: 'BAC Water (31ml)',                       price: 25 },
    { name: 'Starter Pack (10 syringes + 10 wipes)',  price: 5  },
    { name: 'Syringes + Alcohol Wipes (100ct)',       price: 40 },
  ],
};
